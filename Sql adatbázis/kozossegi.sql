...
--------------------------------------------------------
DROP TABLE "CSOPORT_BEJEGYZES";
DROP TABLE "CSOPORTOT_KEZEL";
DROP TABLE "CSOPORT_TAGJA";
DROP TABLE "ISMEROS_KERELEM";
DROP TABLE "JELENTES";
DROP TABLE "KEPEK";
DROP TABLE "KOMMENT";
DROP TABLE "LAJKOLAS";
DROP TABLE "PRIVAT_UZENET";
DROP TABLE "ADMIN";
...
SET DEFINE OFF;
Insert into PRIVAT_UZENET (UZENET_ID,SZOVEG,CIMZETT,KULDES_DATUMA,FELHASZNALONEV) values ('1','Szia, hogy vagy?','nagy.anna@example.com',to_date('25-MÁRC. -23','RR-MON-DD'),'gyilkos_mester');
Insert into PRIVAT_UZENET (UZENET_ID,SZOVEG,CIMZETT,KULDES_DATUMA,FELHASZNALONEV) values ('6','Nagyon hiányzól','nagy.anna@example.com',to_date('25-MÁRC. -23','RR-MON-DD'),'gyilkos_mester');
Insert into PRIVAT_UZENET (UZENET_ID,SZOVEG,CIMZETT,KULDES_DATUMA,FELHASZNALONEV) values ('7','Még mindig szeretlek','nagy.anna@example.com',to_date('25-MÁRC. -23','RR-MON-DD'),'gyilkos_mester');
Insert into PRIVAT_UZENET (UZENET_ID,SZOVEG,CIMZETT,KULDES_DATUMA,FELHASZNALONEV) values ('2','Mikor találkozunk?','toth.gabor@example.com',to_date('25-MÁRC. -23','RR-MON-DD'),'tothgabi');
Insert into PRIVAT_UZENET (UZENET_ID,SZOVEG,CIMZETT,KULDES_DATUMA,FELHASZNALONEV) values ('3','Küldök egy receptet!','szabo.erika@example.com',to_date('25-MÁRC. -23','RR-MON-DD'),'petya12');
Insert into PRIVAT_UZENET (UZENET_ID,SZOVEG,CIMZETT,KULDES_DATUMA,FELHASZNALONEV) values ('4','Megvan a festmény!','horvath.laszlo@example.com',to_date('25-MÁRC. -23','RR-MON-DD'),'ninjasniper');
Insert into PRIVAT_UZENET (UZENET_ID,SZOVEG,CIMZETT,KULDES_DATUMA,FELHASZNALONEV) values ('5','Gratulálok a futáshoz!','peter.kiss@example.com',to_date('25-MÁRC. -23','RR-MON-DD'),'kovacska');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN" MODIFY ("IMSEROSOK_SZAMA" NOT NULL ENABLE);
--------------------------------------------------------
